...
import com.jerryzhiyuan.icity.service.MapOperation;
import com.jerryzhiyuan.icity.util.json.JsonUtil;
import com.jerryzhiyuan.icity.util.json.WriteJson;
...
//        markerInit();
    ...
    public void markerInit(){
        ...
        //输入要请求的url
       String url = "http://172.29.10.71:8080/ICity/GetMomentInfoController";   //本机测试url
